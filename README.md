...
- [Parte 2](#parte-2)
  - [Text Search](#text-search)
    - [Dataset](#dataset-3)
    - [Estrategias](#estrategias-utilizadas-2)
    - [Construcción del Índice Invertido](#construcción-del-índice-invertido)
    - [Consulta (Top-k por Similitud de Coseno)](#consulta-top-k-por-similitud-de-coseno)
    - [Experimentación](#experimentación-2)
    - [Comparación de Resultados: PostgreSQL vs SPIMI](#comparación-de-resultados-postgresql-vs-spimi)
